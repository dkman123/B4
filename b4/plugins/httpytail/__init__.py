...
class HttpytailPlugin(b4.b4_plugin.Plugin):
    ...
    class DiffURLOpener(urllib.request.HTTPRedirectHandler, urllib.request.HTTPDefaultErrorHandler):
        """
        Create sub-class in order to override error 206.
    ...
    def update(self):
        ...
        while not self.stop_event.is_set() and self.console.working:
            ...
            try:
                ...
                # password in the b4 config (eg : http://user:password@host/path)
                ...
                # If we just started b4, we move the cursor to the current file size
                ...
                # many connections (b4/delay is too short)
                ...
                if remoteSize > self._remoteFileOffset:
                    ...
                    # Adding the difference to our file (the file is cleaned at each startup by b4, in parser.py)
        ...
        self.verbose("b4 is down: stopping Httpytail thread")
