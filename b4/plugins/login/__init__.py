...
class LoginPlugin(b4.b4_plugin.Plugin):
    ...
    def onLoadConfig(self):
        ...
        """
        self._threshold = self.getSetting('settings', 'thresholdlevel', b4.INT, self._threshold)
        self._passwdlevel = self.getSetting('settings', 'passwdlevel', b4.INT, self._passwdlevel)
