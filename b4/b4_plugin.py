...
class Plugin(object):
    ...
    def isSetting(self, section, option):
        ...
        :return: True if the section/option matches an entry, False otherwise
        """
        return self.config.has_option(section, option)

    def getSetting(self, section, option, value_type=b4.STRING, default=None, validate=None):
        """
        ...
        def _get_path(value):
            ...
            return b4.getAbsolutePath(str(value), decode=True)
        ...
        handlers = {
            b4.STRING: _get_string,
            b4.INTEGER: _get_integer,
            b4.BOOLEAN: _get_boolean,
            b4.FLOAT: _get_float,
            b4.LEVEL: _get_level,
            b4.DURATION: _get_duration,
            b4.PATH: _get_path,
            b4.TEMPLATE: _get_template,
            b4.LIST: _get_list,
        }
