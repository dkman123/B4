...
class Client(object):
    ...
    def _set_data(self, data):
        #sys.stdout.write("b4_clients.Client._set_data")
        for k, v in data.items():
            self._data[k] = v

    def _get_data(self):
        #sys.stdout.write("b4_clients.Client._get_data")
        return self._data
    ...
    def getGroups(self):
        #sys.stdout.write("b4_clients.Client.getGroups")
        if not self._groups:
            self._groups = []
    ...
    def _get_numBans(self):
        #sys.stdout.write("b4_clients.Client._get_numBans")
        if not self.id:
            return 0
    ...
    def _get_numWarns(self):
        #sys.stdout.write("b4_clients.Client._get_numWarns")
        if not self.id:
            return 0
    ...
    def _set_auto_login(self, autoLogin):
        #sys.stdout.write("b4_clients.Client._set_auto_login")
        self._autoLogin = autoLogin

    def _get_auto_login(self):
        #sys.stdout.write("b4_clients.Client._get_auto_login")
    ...
    def _set_connections(self, v):
        #sys.stdout.write("b4_clients.Client._set_connections")
        self._connections = int(v)

    def _get_connections(self):
        #sys.stdout.write("b4_clients.Client._get_connections")
    ...
    def _set_greeting(self, greeting):
        #sys.stdout.write("b4_clients.Client._set_greeting")
        self._greeting = greeting

    def _get_greeting(self):
        #sys.stdout.write("b4_clients.Client._get_greeting")
    ...
    def _set_groupBits(self, bits):
        #sys.stdout.write("b4_clients.Client._set_groupBits")
        self._groupBits = int(bits)
        self.refreshLevel()

    def _get_groupBits(self):
        #sys.stdout.write("b4_clients.Client._get_groupBits")
        return self._groupBits

    groupBits = property(_get_groupBits, _set_groupBits)

    def addGroup(self, group):
        #sys.stdout.write("b4_clients.Client.addGroup")
        self.groupBits = self.groupBits | group.id

    def setGroup(self, group):
        #sys.stdout.write("b4_clients.Client.setGroup")
        self.groupBits = group.id

    def remGroup(self, group):
        #sys.stdout.write("b4_clients.Client.remGroup")
        self.groupBits = self.groupBits ^ group.id
    ...
    def _set_guid(self, guid):
        #sys.stdout.write("b4_clients.Client._set_guid")
    ...
    def _get_guid(self):
        #sys.stdout.write("b4_clients.Client._get_guid")
        return self._guid
    ...
    def _set_id(self, v):
        #sys.stdout.write("b4_clients.Client._set_id")
        if not v:
            self._id = 0
        else:
            self._id = int(v)
    ...
    def _get_id(self):
        #sys.stdout.write("b4_clients.Client._get_id")
        return self._id
    ...
    def _set_ip(self, ip):
        #sys.stdout.write("b4_clients.Client._set_ip")
        if ':' in ip:
            ip = ip[0:ip.find(':')]
        if self._ip != ip:
    ...
    def _get_ip(self):
        #sys.stdout.write("b4_clients.Client._get_ip")
        return self._ip
    ...
    def _set_login(self, login):
        #sys.stdout.write("b4_clients.Client._set_login")
        self._login = login

    def _get_login(self):
        #sys.stdout.write("b4_clients.Client._get_login")
        return self._login
    ...
    def _set_maskGroup(self, g):
        #sys.stdout.write("b4_clients.Client._set_maskGroup")
        self.maskLevel = g.level
        self._maskGroup = None

    def _get_maskGroup(self):
        #sys.stdout.write("b4_clients.Client._get_maskGroup")
    ...
    def _get_maskedGroup(self):
        #sys.stdout.write("b4_clients.Client._get_maskedGroup")
    ...
    def _set_maskLevel(self, v):
        #sys.stdout.write("b4_clients.Client._set_maskLevel")
        self._maskLevel = int(v)
        self._maskGroup = None

    def _get_maskLevel(self):
        #sys.stdout.write("b4_clients.Client._get_maskLevel")
    ...
    def _set_name(self, name):
        #sys.stdout.write("b4_clients.Client._set_name")
        if self.console:
    ...
    def _get_name(self):
        #sys.stdout.write("b4_clients.Client._get_name")
        return self._name

    def _get_exactName(self):
        #sys.stdout.write("b4_clients.Client._get_exactName")
    ...
    def _set_password(self, password):
        #sys.stdout.write("b4_clients.Client._set_password")
        self._password = password

    def _get_password(self):
        #sys.stdout.write("b4_clients.Client._get_password")
    ...
    def _set_pbid(self, pbid):
        #sys.stdout.write("b4_clients.Client._set_pbid")
        self._pbid = pbid

    def _get_pbid(self):
        #sys.stdout.write("b4_clients.Client._get_pbid")
        return self._pbid
    ...
    def _set_timeAdd(self, timeAdd):
        #sys.stdout.write("b4_clients.Client._set_timeAdd")
        self._timeAdd = int(timeAdd)

    def _get_timeAdd(self):
        #sys.stdout.write("b4_clients.Client._get_timeAdd")
    ...
    def _set_timeEdit(self, timeEdit):
        #sys.stdout.write("b4_clients.Client._set_timeEdit")
        self._timeEdit = int(timeEdit)

    def _get_timeEdit(self):
        #sys.stdout.write("b4_clients.Client._get_timeEdit")
    ...
    def _set_app(self, app):
        #sys.stdout.write("b4_clients.Client._set_app")
        self._app = app

    def _get_app(self):
        #sys.stdout.write("b4_clients.Client._get_app")
        return self._app
    ...
    def _set_isocode(self, isocode):
        #sys.stdout.write("b4_clients.Client._set_isocode")
        self._isocode = isocode

    def _get_isocode(self):
        #sys.stdout.write("b4_clients.Client._get_isocode")
    ...
    def _set_permmute(self, permmute):
        #sys.stdout.write("b4_clients.Client._set_permmute")
        self._permmute = int(permmute)

    def _get_permmute(self):
        #sys.stdout.write("b4_clients.Client._get_permmute")
    ...
    def refreshLevel(self):
        ...
        """
        #sys.stdout.write("b4_clients.Client.refreshLevel")
        self._maxLevel = None
        self._groups = None
    ...
    def disconnect(self):
        ...
        """
        #sys.stdout.write("b4_clients.Client.disconnect")
    ...
    def makeIpAlias(self, ip):
        ...
        """
        #sys.stdout.write("b4_clients.Client.makeIpAlias")
    ...
    def save(self, console=None):
        ...
        """
        #sys.stdout.write("b4_clients.Client.save")
    ...
    def auth(self):
        ...
        if not self.authed and self.guid and not self.authorizing:
            ...
            # check for bans
            #sys.stdout.write('clients numBans = %d' % self.numBans)
            if self.numBans > 0:
                ban = self.lastBan
                if ban:
                    self.reBan(ban)
...
class Struct(object):
    ...
    def _set_id(self, v):
        #sys.stdout.write("b4_clients.Struct.xxxxx")
        if not v:
            self._id = 0
        else:
            self._id = int(v)
...
class Penalty(Struct):
    ...
    def _set_admin_id(self, v):
        #sys.stdout.write("b4_clients.Penalty.xxxxx")
        self._adminId = v
    ...
    def _set_timeExpire(self, v):
        #sys.stdout.write("b4_clients.Penalty._set_timeExpire")
        self._timeExpire = int(v)

    def _get_timeExpire(self):
        #sys.stdout.write("b4_clients.Penalty._get_timeExpire")
    ...
    def save(self, console):
        ...
        """
        #sys.stdout.write("b4_clients.Penalty.save")
...
class ClientWarning(Penalty):
    ...
    def _get_reason(self):
        #sys.stdout.write("b4_clients.ClientWarning._get_reason")
        return self.reason
...
class ClientNotice(Penalty):
    ...
    def _get_reason(self):
        #sys.stdout.write("b4_clients.ClientNotice._get_reason")
        return self.reason

    def _set_reason(self, v):
        #sys.stdout.write("b4_clients.ClientNotice._set_reason")
        self.reason = v
...
class Clients(dict):
    ...
    def lookupSuperAdmins(self):
        ...
        """
        #sys.stdout.write("b4_clients.Clients.lookupSuperAdmins")
        try:
    ...
    def resetIndex(self):
        ...
        Reset the indexes.
        """
        #sys.stdout.write("b4_clients.Clients.resetIndex")
        self._nameIndex = {}
        self._guidIndex = {}
        self._exactNameIndex = {}
    ...
    def newClient(self, cid, **kwargs):
        ...
        """
        #sys.stdout.write("b4_clients.Clients.newClient")
